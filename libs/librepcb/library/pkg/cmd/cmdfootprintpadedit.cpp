...
void CmdFootprintPadEdit::setWidth(const UnsignedLength& width, bool immediate) noexcept
{
    Q_ASSERT(!wasEverExecuted());
    mNewWidth = width;
...
void CmdFootprintPadEdit::setHeight(const UnsignedLength& height, bool immediate) noexcept
{
    Q_ASSERT(!wasEverExecuted());
    mNewHeight = height;
